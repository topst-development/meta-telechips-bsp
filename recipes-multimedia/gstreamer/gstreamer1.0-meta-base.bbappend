DEPENDS:append  = " gstreamer1.0-plugins-telechips gstreamer1.0-omx"
...
"
RDEPENDS:gstreamer1.0-meta-video += "${@oe.utils.conditional('VIDEO_SINK', 'waylandsink', 'gstreamer1.0-plugins-bad-waylandsink', '',d)}"
