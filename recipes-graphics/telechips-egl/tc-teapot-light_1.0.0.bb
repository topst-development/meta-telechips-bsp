...
"
SRCREV = "72ec4fd3e14ab0e50029be71b548f659f755571b"
...
# for systemd
SYSTEMD_PACKAGES = "${PN}"
SYSTEMD_SERVICE:${PN} = "${@bb.utils.contains("DISTRO_FEATURES", "wayland", "tc-teapot-light.service tc-teapot-light.path", "tc-teapot-light.service", d)}"
